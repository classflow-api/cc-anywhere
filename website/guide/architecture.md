...
实现见 [Server/internal/router/router.go](https://github.com/classflow-api/cc-anywhere/blob/master/Server/internal/router/router.go)。
...
实现见 [ProcessHost.makeEnvironment](https://github.com/classflow-api/cc-anywhere/blob/master/MacClient/Sources/CCAnywhere/Services/ProcessHost.swift)。
...
改用 BSD `socket(2) + bind(2) + listen(2)` + `DispatchSourceRead` 实现 accept loop。详见 [HookIpcServer.swift](https://github.com/classflow-api/cc-anywhere/blob/master/MacClient/Sources/CCAnywhere/Services/HookIpcServer.swift) 顶部注释。
...
[docs/AskUserQuestion远程交互/](https://github.com/classflow-api/cc-anywhere/blob/master/docs/AskUserQuestion%E8%BF%9C%E7%A8%8B%E4%BA%A4%E4%BA%92/)
